...
void GENERAL_TIM_INT_FUN_PP(void)
{
  	if ( TIM_GetITStatus ( GENERAL_TIM_PP , TIM_IT_Update) != RESET )               
	{	
    PWM_Width_change(CCR3_Val);		
		TIM_ClearITPendingBit ( GENERAL_TIM_PP , TIM_FLAG_Update ); 		
	}
}
